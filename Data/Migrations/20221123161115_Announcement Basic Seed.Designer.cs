...
namespace ZyzzGymOriginal.Data.Migrations
{
    ...
    [Migration("20221123161115_Announcement Basic Seed")]
    partial class AnnouncementBasicSeed
    {
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.AnnouncementEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4909),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4909)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4916),
                            ...
                            Title = "New delivery of Whey Protein Complex",
                            UpdatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4917)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4922),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4922)
                        });
                });
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.PricingEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4879),
                            Description = "You can train when and how much you want!",
                            PassTypeName = "24/7 Gym Pass",
                            Price = 29.99f,
                            UpdatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4881)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4895),
                            Description = "You can train only at night (21:00 - 06:00)!",
                            PassTypeName = "Night Gym Pass",
                            Price = 14.99f,
                            UpdatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4896)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4901),
                            ...
                            Price = 19.99f,
                            UpdatedAt = new DateTime(2022, 11, 23, 16, 11, 15, 627, DateTimeKind.Utc).AddTicks(4901)
                        });
                });
