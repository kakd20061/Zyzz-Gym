...
namespace ZyzzGymOriginal.Data.Migrations
{
    ...
    [Migration("20221124223130_Achieve Edit")]
    partial class AchieveEdit
    {
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.AnnouncementEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5882),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5883)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5890),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5890)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5896),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5896)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5901),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5901)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5906),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5906)
                        });
                });
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.PricingEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5851),
                            Description = "You can train when and how much you want!",
                            PassTypeName = "24/7 Gym Pass",
                            Price = 29.99f,
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5853)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5866),
                            Description = "You can train only at night (21:00 - 06:00)!",
                            PassTypeName = "Night Gym Pass",
                            Price = 14.99f,
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5866)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5872),
                            ...
                            Price = 19.99f,
                            UpdatedAt = new DateTime(2022, 11, 24, 22, 31, 30, 502, DateTimeKind.Utc).AddTicks(5872)
                        });
                });
