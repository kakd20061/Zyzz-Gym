...
namespace ZyzzGymOriginal.Data.Migrations
{
    ...
    [Migration("20221121213405_Pricing Basic Seed")]
    partial class PricingBasicSeed
    {
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.PricingEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 21, 21, 34, 5, 542, DateTimeKind.Utc).AddTicks(4850),
                            Description = "You can train when and how much you want!",
                            PassTypeName = "24/7 Gym Pass",
                            Price = 29.99f,
                            UpdatedAt = new DateTime(2022, 11, 21, 21, 34, 5, 542, DateTimeKind.Utc).AddTicks(4851)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 21, 21, 34, 5, 542, DateTimeKind.Utc).AddTicks(4865),
                            Description = "You can train only at night (21:00 - 06:00)!",
                            PassTypeName = "Night Gym Pass",
                            Price = 14.99f,
                            UpdatedAt = new DateTime(2022, 11, 21, 21, 34, 5, 542, DateTimeKind.Utc).AddTicks(4865)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 21, 21, 34, 5, 542, DateTimeKind.Utc).AddTicks(4871),
                            ...
                            Price = 19.99f,
                            UpdatedAt = new DateTime(2022, 11, 21, 21, 34, 5, 542, DateTimeKind.Utc).AddTicks(4872)
                        });
                });
