...
namespace ZyzzGymOriginal.Data.Migrations
{
    ...
    [Migration("20221129121456_Requests Update")]
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.AnnouncementEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1724),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1726)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1734),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1734)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1740),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1740)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1745),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1745)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1750),
                            ...
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1750)
                        });
                });
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.ExerciseNameEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1759),
                            Name = "Bench Press",
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1760)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1768),
                            Name = "Shoulder Press",
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1768)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1774),
                            Name = "Squat",
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1774)
                        });
                });
            ...
            modelBuilder.Entity("ZyzzGymOriginal.Data.PricingEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1694),
                            Description = "You can train when and how much you want!",
                            PassTypeName = "24/7 Gym Pass",
                            Price = 29.99f,
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1695)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1709),
                            Description = "You can train only at night (21:00 - 06:00)!",
                            PassTypeName = "Night Gym Pass",
                            Price = 14.99f,
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1709)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1716),
                            ...
                            Price = 19.99f,
                            UpdatedAt = new DateTime(2022, 11, 29, 12, 14, 56, 345, DateTimeKind.Utc).AddTicks(1716)
                        });
                });

            modelBuilder.Entity("ZyzzGymOriginal.Data.RequestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
